...
use App\InitClass\InitUdpEchoServer;
 ...
 */
class UdpEchoServer extends Console
{
    /**
     * @var string $identifer サーバー識別子
     */
    protected string $identifer = 'app:udp-echo-server {max_concurrent_connections?} {port?}';

    /**
     * @var string $description コマンド説明
     */
    protected string $description = 'UDP エコーサーバー';
    ...
    public function exec()
    {
        ...
        $broadcast = config('const.broadcast_udp', false);
