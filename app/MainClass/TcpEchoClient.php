...
use App\InitClass\InitTcpEchoClient;
 ...
 */
class TcpEchoClient extends Console
{
    /**
     * @var string $identifer サーバー識別子
     */
    protected string $identifer = 'app:tcp-echo-client {port?}';

    /**
     * @var string $description コマンド説明
     */
    protected string $description = 'TCP クライアント';
    ...
    public function exec()
    {
         ...
         * 
         */
        $init = new InitTcpEchoClient($this->port);
